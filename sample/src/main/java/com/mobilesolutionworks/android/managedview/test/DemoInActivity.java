 ...
 */
public class DemoInActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ManagedDropDown dropDown = (ManagedDropDown) findViewById(R.id.info_list);
        dropDown.setList(list);

        findViewById(R.id.info_list).setOnClickListener(this);
        findViewById(R.id.info_listResource).setOnClickListener(this);
        ...
        switch (v.getId()) {
            case R.id.info_list: {
                ...
                new AlertDialog.Builder(this).
                        setSingleChoiceItems(new ArrayAdapter<KeyValueObject>(this, android.R.layout.simple_list_item_1, list), -1, new DialogInterface.OnClickListener() {
                            @Override
            ...
            case R.id.info_listResource: {
                new AlertDialog.Builder(this).
                        setSingleChoiceItems(new ArrayAdapter<String>(this, android.R.layout.simple_list_item_1, getResources().getStringArray(R.array.listResources)), -1, new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {

                                String[] array = getResources().getStringArray(R.array.listResources);
                                ManagedDropDown dropDown = (ManagedDropDown) findViewById(R.id.info_listResource);
            ...
            case R.id.info_date: {
                ...
                mPickerDialog = new DatePickerDialog(this, new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                        ...
                        ManagedButton button = (ManagedButton) findViewById(R.id.info_date);
                        button.setText(date);
